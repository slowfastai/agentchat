/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: d490c290ae9d57bc3190be29e8b6a1a8)
// Runtime types generated with workerd@1.20260317.1 2026-03-23 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeviceHubDO" | "PairingIndexDO";
	}
	interface Env {
		RELAY_DEV_MODE: "true";
		DEVICE_HUB: DurableObjectNamespace<import("./src/index").DeviceHubDO>;
		PAIRING_INDEX: DurableObjectNamespace<import("./src/index").PairingIndexDO>;
	}
}
